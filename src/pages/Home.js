    ...
    return (
        <div className="min-h-screen">
            <div className="container pt-5 d-flex flex-column align-items-center">
                <img src={avtar} width={200} alt="Daksh panchal" />
                <h1>Daksh panchal</h1>
                <h4>(App Developer)</h4>
                <p className="text-center border-bottom pb-3">Hello,I'm Daksh Panchal! i am app devloper with the skills of Python,Java,Css,Html.</p>
                <p className="text-center">
                    <span className="d-mobile-block">Email: dakshpanchal053@gmail.com</span>
                    <span className="d-none d-web-contents"> | </span>
                    <span className="d-mobile-block">Phone: +91-8866440427</span>
                </p>
                <p className="text-center">Address: G-203,Narayan residancy,Nikol Gam,Ahmedabad IN - 382350</p>
            </div>
            <hr />
